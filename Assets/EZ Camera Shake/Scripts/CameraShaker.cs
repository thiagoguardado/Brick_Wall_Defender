...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
		...
		[Header("Short Shake")]
		public float short_magnitude;
		public float short_roughness;
		public float short_fadeInTime;
		public float short_fadeOutTime;


		[Header("Long Shake")]
		public float long_magnitude;
		public float long_roughness;
		public float long_fadeInTime;
		public float long_fadeOutTime;
		...
		public void ShortShake(){
			...
			CameraShakeInstance c = CameraShaker.Instance.ShakeOnce(short_magnitude, short_roughness, short_fadeInTime, short_fadeOutTime);
			c.PositionInfluence = DefaultPosInfluence;
			c.RotationInfluence = DefaultRotInfluence;
		...
		public void LongShake(){
			...
			CameraShakeInstance c = CameraShaker.Instance.ShakeOnce(long_magnitude, long_roughness, long_fadeInTime, long_fadeOutTime);
			c.PositionInfluence = DefaultPosInfluence;
			c.RotationInfluence = DefaultRotInfluence;
